...
interface LoMasVendidoProductCardProps {
  product: IProduct;
  viewMode?: "grid" | "list";
...
const LoMasVendidoProductCard = memo(function LoMasVendidoProductCard({
  product,
  viewMode = "grid",
  mainCategory,
  description,
}: LoMasVendidoProductCardProps) {
...
export default LoMasVendidoProductCard;
