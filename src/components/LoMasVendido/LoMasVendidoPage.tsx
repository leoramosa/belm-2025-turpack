...
export default function LoMasVendidoPage({
  products,
  categories,
  attributes,
}: LoMasVendidoPageProps) {
  ...
  // sortBy siempre es "popularity" para esta página
  ...
  const filteredProducts = useMemo(() => {
    ...
    // Ordenamiento (siempre por popularidad para productos más vendidos)
    // Para productos más vendidos, mantener el orden original
    // (ya vienen ordenados por popularidad del servidor)
    // No se necesita sort ya que vienen ordenados del servidor
