			...
			<div className="w-full mx-auto px-4 lg:px-8">
				...
				<div className="text-center mb-6 animate-fade-in-up">
					...
					<p className="text-md text-gray-600 animate-fade-in-up animation-delay-400">
						Descubre nuestra línea completa de{' '}
						<strong> Skincare, Belleza y Moda</strong>, seleccionamos con mucho
						cariño las mejores marcas para que siempre encuentres ese detalle
						especial que te hace brillar.
					</p>
				</div>
