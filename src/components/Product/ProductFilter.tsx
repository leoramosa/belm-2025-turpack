...
export function ProductFilter({
  ...
  const handleSubcategorySelect = (subcategorySlug: string | null) => {
    if (subcategorySlug) {
      ...
      // Navegar a la página de la subcategoría
  ...
  const handleSubSubcategorySelect = (subSubcategorySlug: string | null) => {
    if (subSubcategorySlug) {
      ...
      // Navegar a la página de la sub-subcategoría
  ...
  return (
    <div className="hidden lg:block w-80 shrink-0">
      ...
      {/* Search */}
      <div className="space-y-2">
        <label className="text-sm font-semibold text-zinc-700">Buscar</label>
        <input
          type="text"
          placeholder="Buscar..."
          value={filters.search}
          onChange={(e) => handleFilterChange({ search: e.target.value })}
          className="w-full rounded-lg border border-zinc-300 px-3 py-2 text-sm text-zinc-900 placeholder:text-zinc-400 focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20"
        />
      </div>
      ...
      {colorOptions.length > 0 && (
        <div className="space-y-2">
          <label className="text-sm font-semibold text-zinc-700">Colores</label>
      ...
      {/* Tags */}
      <div className="space-y-2">
        <label className="text-sm font-semibold text-zinc-700">Etiquetas</label>
        <div className="space-y-2">
