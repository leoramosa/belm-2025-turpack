...
export function getSectionIntroText(
	...
	const intros = {
		new: [
			'Novedades exclusivas en skincare, belleza y moda de tus marcas favoritas.',
		],
		bestseller: [
			'Estos son los top en ventas que nuestra comunidad adora. ¡Descubre por qué!',
		],
		sale: [
			'Aprovecha las ofertas de temporada y llévate las tendencias por menos. ¡No te lo pierdas!',
		],
